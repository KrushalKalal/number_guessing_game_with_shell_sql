...
GET_GAMES=$($PSQL "SELECT COUNT(*) FROM users INNER JOIN games USING(user_id) WHERE username='$USERNAME'")
...
then 
  ...
  echo "Welcome, $USERNAME! It looks like this is your first time here."
   ...
   echo "Welcome back, $USERNAME! You have played $GET_GAMES games, and your best game took $BEST_GAME guesses."
fi
